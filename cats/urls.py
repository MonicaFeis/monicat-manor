...
urlpatterns = [
    ...
    path(
        'cat/<int:pk>/edit/', views.CatUpdateView.as_view(),
        name='cat_update'
    ),
    path(
        'cat/<int:pk>/delete/', views.CatDeleteView.as_view(),
        name='cat_delete'
    ),
    path(
        'cat/<int:pk>/toggle-visibility/', views.toggle_visibility,
        name='cat_toggle_visibility'
    ),

    path('cat/<int:pk>/comment/', views.add_comment, name='comment_create'),
    path(
        'comment/<int:pk>/edit/', views.CommentUpdateView.as_view(),
        name='comment_update'
    ),
    path(
        'comment/<int:pk>/delete/', views.CommentDeleteView.as_view(),
        name='comment_delete'
    ),
